...
#define SAVE_ROTATION_32X64         0x9A
...
void transmit_data(char cmd)
{
  ...
  // Serial.print("sendLen : "); Serial.println(sendLen);
...
void transmit_data2(char cmd, char* data, uint32_t len)
{
  uint16_t crc = 0;
  uint32_t inx = 0;
  uint8_t* sendData;
